...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = ADC1_APPS1_Pin|ACD1_APPS2_Pin;
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA2     ------> ADC2_IN2
    */
    GPIO_InitStruct.Pin = ADC2_DMPR1_Pin|ADC2_DMPR2_Pin|ADC2_DMPR3_Pin|ADC2_DMPR4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC3_AUX1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC3_AUX1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = ADC3_AUX1_Pin|ADC3_AUX2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOA, ADC1_APPS1_Pin|ACD1_APPS2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA2     ------> ADC2_IN2
    */
    HAL_GPIO_DeInit(GPIOC, ADC2_DMPR1_Pin|ADC2_DMPR2_Pin|ADC2_DMPR3_Pin|ADC2_DMPR4_Pin);

    HAL_GPIO_DeInit(ADC3_AUX1_GPIO_Port, ADC3_AUX1_Pin);
